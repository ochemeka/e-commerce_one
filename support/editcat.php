...
$db_images = "";
			...
			if (empty($errors)) {
				...
				if ($result) {
				echo "<script type='text/javascript'>alert('Product Category Updated Successfully !')</script>";
				redirect_to('managecategory.php');
					
				} else {
					// Display error message.
					echo "<p>Product Category Update failed.</p>";
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Edit Product Category</h3>
                        <ol class="breadcrumb">
...
<!--start dependable menu-->
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-block">
                            <h4 class="card-title">Manage Edit Product Category </h4>
                            <h6 class="card-subtitle">Category</h6>
                            <form class="form-horizontal m-t-40" method="post" enctype="multipart/form-data" action="<?php echo SITE_PATH; ?>support/editcat.php?catid=<?php echo $_GET['catid']; ?>">
			...
			?>
                                <div class="form-group">
                                    <label>Category Name:<span class="help">(Current Name - "<?php echo $cat_part['cat_name'];?>")</span></label>
                                    <input type="text" name="cat_name" placeholder="Enter Product Category Name" class="form-control" value="<?php echo $cat_part['cat_name'];?>">
                                </div>
								
								<div class="form-group">
                                    <label for="example-email">Category Slug: <span class="help"> e.g. "clothes"</span></label>
                                    <input type="text" name="catno" placeholder="Enter Category Slug" class="form-control"  value="<?php echo $cat_part['cat_slug'];?>" >
                                </div>
...
?>
                        <img style="width:200px; height:70px" src="<?php echo SITE_PATH; ?>uploads/<?php echo $img_url1;  ?>" alt="" /><br />
                         <?php }} ?>
