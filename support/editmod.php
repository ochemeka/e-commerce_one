...
$pagetitle = "Manage Mod || Buy at Affordable Prices in Nigeria || Bubinod Kidz Palace - Online Shopping Mall";
?>
<?php admin_logged_in(); ?>
<?php include ("includes/dash-header.php"); ?>
 <?php 
$mod = get_module($_GET['modid']);
$mod_part = mysqli_fetch_array($mod);
...
$db_images = "";
			...
			if (empty($errors)) {
				...
				if ($result) {
				echo "<script type='text/javascript'>alert('Modules Updated Successfully !')</script>";
				redirect_to('managemodule.php');
					
				} else {
					// Display error message.
					echo "<p>Module Update failed.</p>";
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Edit Category Module</h3>
                        <ol class="breadcrumb">
...
<!--start dependable menu-->
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-block">
                            ...
                            <form class="form-horizontal m-t-40" method="post" enctype="multipart/form-data" action="<?php echo SITE_PATH; ?>support/editmod.php?modid=<?php echo $_GET['modid']; ?>">
			...
			?>
                                  <div class="form-group">
                                    <label>Category Name: <span>(Current Cat:  <?php
									$md = $mod_part['cat_no']; 
								  $query1="SELECT * from category WHERE cat_no = $md order by cat_id";
								  $result1 = mysqli_query($connection,$query1);
									$ct_set=mysqli_fetch_array($result1);
									echo $ct_set["cat_name"];
							   ?>)</span></label>
							   ...
							   ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mod_no" value="<?php echo $mod_part['module_no']; ?>" placeholder="Enter Module Number" class="form-control">
                                </div>
								<div class="form-group">
                                    <label>Module Title: (Current Mod - <?php echo $mod_part['module_title']; ?>)</label>
                                    <textarea name="title" value="<?php echo $mod_part['module_title']; ?>" class="form-control" rows="5"></textarea>
                                </div>
                                <!--<div class="form-group">
                                    <label>Email</label>
