...
redirect_to("managecswf.php?status=asuccess");
}
}
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Manage All CSWF</h3>
                        <ol class="breadcrumb">
...
$results = $connection->query("SELECT COUNT(*) FROM commonsense "); //get total number of records from database
...
$results = $connection->query("SELECT * FROM commonsense WHERE f_status != 7 ORDER BY f_id ASC LIMIT $page_position, $item_per_page");
                        ...
                        <td><?php echo $row['f_title']; ?></td>
						 <td>
							<div class="fluid-video-wrapper">
							  <iframe width="100" height="60" src="<?php echo $row['f_video']; ?>?autoplay=false&autopause=0" frameborder="0" allowfullscreen></iframe>
							</div>
						 </td>
						 <td><?php echo $row['f_postby']; ?></td>
...
?>
                        ...
                        <td>(<?php if($row['f_status']==1){ ?><a href="managecswf.php?disapprove=<?php echo $row['f_id']; ?>" style="color:#FF6600;" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="managecswf.php?approve=<?php echo $row['f_id']; ?>" style="color:#009900;" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="managecswf.php?delete=<?php echo $row['f_id']; ?>" style="color:#FF6600;" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="editcswf.php?cswf=<?php echo $row['f_id']; ?>" style="color:#009900;">Edit</a>)</td>
                      </tr>
											<?php
