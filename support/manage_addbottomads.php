...
<?php
$pagetitle="Manage Ads Banner || Buy at Affordable Prices in Nigeria || Bubinod Kidz Palace - Online Shopping Mall";
...
$db_images = "";
			...
			if (empty($errors)) {
				...
				$query = "INSERT INTO bottomadstbl (
						name, image, time
						) VALUES (
							'{$title}', '{$passport}', '{$time}')";
				...
				if ($result) {
				//$rs = $resta;
				echo "<script type='text/javascript'>alert('Bottom Ads Creation Successful!')</script>";
				redirect_to('manage_Viewbottomads');
					
				} else {
					// Display error message.
					echo "<p>Bottom Ads Creation Failed.</p>";
...
?>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Create Home BottomAds Banner</h3>
                        <ol class="breadcrumb">
			...
			?>
								...
								<div class="form-group">
								 <h4 class="card-title">Upload Banner Images (1650 x 180)</h4>
