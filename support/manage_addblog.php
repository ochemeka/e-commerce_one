...
$db_images = "";
			...
			if (empty($errors)) {
				...
				$query = "INSERT INTO blog (
						image, title, description, uploadedby, time
						) VALUES (
							'{$passport}', '{$title}', '{$content}', '{$author}', '{$time}')";
						
						
         
				$result = mysqli_query($connection,$query);
				if ($result) {
				echo "<script type='text/javascript'>alert('Blog Creation Successful!')</script>";
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Create News Article</h3>
                        <ol class="breadcrumb">
...
<!--start dependable menu-->
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-block">
                            <h4 class="card-title">Add News &amp; Media </h4>
			...
			?>
                                <div class="form-group">
                                    ...
                                    <input type="text"  placeholder="Enter Blog Title" name="title" class="form-control" value="">
                                </div>
								
                                <div class="form-group">
                                    <label for="example-email">Blog Author:<span class="help"> e.g. "William Shakespear"</span></label>
                                    <input type="text" name="author" placeholder="Enter Article Author" class="form-control" >
                                </div>
								<div class="form-group">
