...
<?php
$pagetitle="Manage Top Ads Banner || Buy at Affordable Prices in Nigeria || Bubinod Kidz Palace - Online Shopping Mall";
...
$db_images = "";
			...
			if (empty($errors)) {
				...
				$query = "INSERT INTO top_adstbl (
						ads_name, ads_image, time
						) VALUES (
							'{$title}', '{$passport}', '{$time}')";
				...
				if ($result) {
				//$rs = $resta;
				echo "<script type='text/javascript'>alert('Top Right Ads Banner Creation Successful!')</script>";
				redirect_to('manage_Viewtopads');
					
				} else {
					// Display error message.
					echo "<p>Top Right Ads Banner Creation Failed.</p>";
...
?>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Add New Top Right Ads Banner</h3>
                        <ol class="breadcrumb">
			...
			?>
								...
								<div class="form-group">
								 <h4 class="card-title">Upload TopRight Ads Images (270 x 220)</h4>
