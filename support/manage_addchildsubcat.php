...
$db_images = "";
			...
			$required_fields = array('cat_name','subcat','subchildcat');
			...
			if (empty($errors)) {
				...
				$query = "INSERT INTO submodel (
						catid, model, submodel
							...
							'{$cat_name}', '{$subcat}', '{$subchildcat}')";
						
						
         
				$result = mysqli_query($connection,$query);
				if ($result) {
				echo "<script type='text/javascript'>alert('Product Sub Child Category Creation Successful!')</script>";
				redirect_to('managesubcat.php');
					
				} else {
					// Display error message.
					echo "<p>Product Sub Child Category Ceation Failed.</p>";
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Create Product Sub Child Category</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Sub Child Category</li>
                        </ol>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-block">
                            <h4 class="card-title">Add New Product Sub Child Category </h4>
			 ...
			 // $cat_set=mysqli_fetch_array($result);
 			  ?>
                                <div class="form-group">
									...
									<select type="text" name="cat_name" id="country-list" require="require" onChange="getState(this.value);" class="custom-select col-12" value="" placeholder="Category Name*" />
...
?>
								...
								<div class="form-group">
                                   ...
                                   <select type="text" name="subcat" id="state-list" require="require" class="form-control input-lg" value="" placeholder="Sub Category*" />
								...
								<div class="form-group">
                                    <label>Sub Child Category Name:<span class="help">e.g. "Male"</span></label>
                                    <input type="text" name="subchildcat" placeholder="Enter Product Sub Child Category Name" class="form-control" value="">
                                </div>
