...
<?php
$pagetitle="Manage Recommended Ads Banner";
...
$db_images = "";
			...
			if (empty($errors)) {
				...
				$query = "INSERT INTO recadstbl (
						r_adsname, r_adsimage, r_time
						) VALUES (
							'{$title}', '{$passport}', '{$time}')";
				...
				if ($result) {
				//$rs = $resta;
				echo "<script type='text/javascript'>alert('Recommended Ads Banner Creation Successful!')</script>";
				redirect_to('manage_ViewRecommended');
					
				} else {
					// Display error message.
					echo "<p>Recommended Ads Banner Creation Failed.</p>";
...
?>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Create Recommended Ads Banner</h3>
                        <ol class="breadcrumb">
			...
			?>
								...
								<div class="form-group">
								 <h4 class="card-title">Upload Slider Images (250 x 390)</h4>
