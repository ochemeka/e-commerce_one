...
$scat = get_subcategory($_GET['sid']);
$subcat_part = mysqli_fetch_array($scat);
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Edit Product Sub Category</h3>
                        <ol class="breadcrumb">
...
<!--start dependable menu-->
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-block">
                            <h4 class="card-title">Manage Edit Product Sub Category </h4>
                            <h6 class="card-subtitle">Sub Category</h6>
                            <form class="form-horizontal m-t-40" method="post" enctype="multipart/form-data" action="<?php echo SITE_PATH; ?>support/editsubcat.php?sid=<?php echo $_GET['sid']; ?>">
			...
			?>
								...
								<div class="form-group">
                                    <label>Category Name:<span class="help">(Current Cat Name - "<?php echo $subcat_part['category'];?>")</span></label>
                                    <select class="custom-select col-12" placeholder="Select Sub Category Name" name="cat_name">
								...
								<div class="form-group">
                                    <label for="example-email">Sub Category Name: <span class="help"> e.g. "clothes"</span></label>
                                    <input type="text" name="subcat_name" placeholder="Enter Sub Category Name" class="form-control"  value="<?php echo $subcat_part['model'];?>" >
                                </div>
