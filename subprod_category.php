...
$sID = $_GET['scat'];
$spID = $_GET['spcat'];
$results = $connection->query("SELECT * FROM products WHERE pr_category = '$cID' AND pr_subcat = '$sID' AND pr_subchildcat = '$spID' AND status = 1 ORDER BY id DESC LIMIT $page_position, $item_per_page");
