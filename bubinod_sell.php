...
<?php
$pagetitle="Sell on Bubinod || Buy at Affordable Prices in Nigeria || Bubinod Kidz Palace - Online Shopping Mall";
?>
...
//$db_images = "";
			...
			$required_fields = array('firstname','lastname','email','telephone','gender','category','address','bustop','city','state','country','desc');
			...
			//if(strlen($db_images) < 7){ $errors[] = "No image upload"; }
				...
				$phone = stripslashes($_REQUEST['telephone']);
			...
			if (mysqli_num_rows($result_set) == 1) {*/
				...
				$query = "INSERT INTO bubinodsales (
						firstname, lastname, email, phone, gender, category, address, city, bustop, state, country, description, time
						) VALUES (
							'{$firstname}', '{$lastname}', '{$email}', '{$telephone}', '{$gender}', '{$category}', '{$address}', '{$city}', '{$bustop}', '{$state}', '{$country}', '{$desc}', '{$date}')";
...
?>  
	...
	<div class="main-container container">
		<ul class="breadcrumb">
			...
			<li><a href="#">Sell on Bubinod</a></li>
		</ul>
		
		<div class="row">
			<!--Middle Part Start-->
			<div id="content" class="col-sm-12">
				<h2 class="title">Want to sell your product on Bubinod Kidz Palace ?</h2>
				<p>Please complete the form below to start your process.</p>
			...
			?>
					<fieldset>
						...
						<div class="form-group required">
							<label for="input-order-id" class="col-sm-2 control-label">Gender</label>
							<div class="col-sm-10">
					...
					<fieldset>
						...
						<div class="form-group required">
							<label for="input-product" class="col-sm-2 control-label">Address</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="input-product" placeholder="Address" value="" name="address">
							</div>
						</div>
						<div class="form-group required">
							<label for="input-model" class="col-sm-2 control-label">City</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="input-model" placeholder="City" value="" name="city">
							</div>
						</div>
						<div class="form-group">
							<label for="input-quantity" class="col-sm-2 control-label">Nearest Bustop</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="input-quantity" placeholder="Nearest Bustop"  name="bustop">
							</div>
						</div>
						<div class="form-group">
