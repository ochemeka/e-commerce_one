...
function get_about(){
	...
	function get_resetuser($username){
	global $connection;
	$query = "SELECT * 
				FROM memberstbl 
	...
	function get_CustOrder(){
	global $connection;
	$query = "SELECT * 
				FROM order_items
				WHERE status != 20  
				GROUP BY (invoiceID) ASC";
		$cat_set = mysqli_query($connection,$query);
		confirm_query($cat_set);
		return $cat_set;
	}
	function get_CustListing(){
	global $connection;
	$query = "SELECT * 
				FROM foodlist
				WHERE f_status != 7  
	...
	function get_vendor_data11($vend11){
	global $connection;
	$query = "SELECT * 
				FROM order_items  
				WHERE vendor =  '{$vend11}' 
	...
	function get_vendor_data22($vend22){
	global $connection;
	$query = "SELECT * 
				FROM order_items  
				WHERE vendor =  '{$vend22}' 
	...
	function get_vendor_data33($vend33){
	global $connection;
	$query = "SELECT * 
				FROM order_items  
				WHERE vendor =  '{$vend33}' 
	...
	function get_all_userOder($user){
	global $connection;
	$query = "SELECT * 
				FROM custorders  
				WHERE email =  '{$user}' 
	...
	function get_all_userOder00($user1){
	global $connection;
	$query = "SELECT * 
				FROM custorders  
				WHERE email =  '{$user1}' 
	...
	function get_all_userOder11($user1){
	global $connection;
	$query = "SELECT * 
				FROM custorders  
				WHERE email =  '{$user1}' 
	...
	function get_all_userOder22($user2){
	global $connection;
	$query = "SELECT * 
				FROM custorders  
				WHERE email =  '{$user2}' 
...
function get_gal_id($gal){
	...
	function get_vendor_id($vendor){
	global $connection;
	$query = "SELECT * 
				FROM vendors 
				WHERE v_email = '{$vendor}'   
				ORDER BY v_id ASC";
		$cat_set = mysqli_query($connection,$query);
		confirm_query($cat_set);
		return $cat_set;
